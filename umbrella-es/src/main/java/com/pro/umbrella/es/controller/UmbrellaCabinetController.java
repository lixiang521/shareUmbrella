...
//    }
    ...
    public static CabinetQueryParam transform(CabinetQueryWebParam it) {
        ...
        cabinetQueryParam.setShopCode(it.getShopCode());
        ...
        cabinetQueryParam.setSceneType(ParamUtils.toList(it.getSceneType()));
        cabinetQueryParam.setScene(ParamUtils.toList(it.getScene()));
        cabinetQueryParam.setDeviceId(it.getDeviceId());
        cabinetQueryParam.setClientId(it.getClientId());
        cabinetQueryParam.setClientName(it.getClientName());
        cabinetQueryParam.setPointId(it.getPointId());
        cabinetQueryParam.setPointName(it.getPointName());
        cabinetQueryParam.setLocation(it.getLocation());
        ...
        cabinetQueryParam.setMinUnsortedCap(ParamUtils.toInt(it.getMinUnsortedCap()));
        cabinetQueryParam.setMaxUnsortedCap(ParamUtils.toInt(it.getMaxUnsortedCap()));
        ...
        cabinetQueryParam.setMinMigrateDate(ParamUtils.toLong(it.getMinMigrateDate()));
        cabinetQueryParam.setMaxMigrateDate(ParamUtils.toLong(it.getMaxMigrateDate()));
        ...
        cabinetQueryParam.setProvince(it.getProvince());
        cabinetQueryParam.setCity(ParamUtils.toList(it.getCity()));
        cabinetQueryParam.setDistrict(it.getDistrict());

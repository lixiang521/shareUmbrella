...
import com.blibee.umbrella.common.CommonConstants;
...
public class Safes {
    ...
    public static String of(String source) {
        return Optional.ofNullable(source).orElse(CommonConstants.STRING_EMPTY);
    }
    ...
    static String trimToEmpty(String str) {
        return str == null ? CommonConstants.STRING_EMPTY : str.trim();
    }
}
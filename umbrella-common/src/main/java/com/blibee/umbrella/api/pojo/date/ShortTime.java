package com.blibee.umbrella.api.pojo.date;
...
final public class ShortTime implements Serializable, Comparable<ShortTime> {
    ...
    /**
     * @deprecated 请使用 {@link #getEndOfDay()}
     */
    @Deprecated
    public static ShortTime END_OF_DAY = ShortTime.create("23:59:59");

    /**
     * @deprecated 请使用 {@link #getStartOfDay()}
     */
    @Deprecated
    ...
    public static ShortTime create(String time) {
        Preconditions.checkArgument(StringUtils.hasText(time));
        String[] p = time.split(":");
        int h, m, s;
     ...
     *
     * @see ShortTime#create(org.joda.time.DateTime)
     */
    ...
    public static ShortTime getStartOfDay() {
        return ShortTime.create("00:00:00");
    }

    public static ShortTime getEndOfDay() {
        return ShortTime.create("23:59:59");
    }
    ...
    public ShortTime addMinutes(int delta) {
        return ShortTime.create(toSeconds() + delta * 60);
    }
    ...
    public ShortTime addSeconds(int delta) {
        return ShortTime.create(toSeconds() + delta);
    }

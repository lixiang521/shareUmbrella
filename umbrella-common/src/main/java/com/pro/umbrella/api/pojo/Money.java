package com.pro.umbrella.api.pojo;
...
public final class Money implements Comparable<Money>, Serializable {
	...
	/**
	 * @see MoneyUtils#DEFAULT_CURRENCY
	 */
	@Deprecated
	public static final Currency DEFAULT_CURRENCY = Currency.CNY;

	public static final transient MathContext DEF_MC = MathContext.DECIMAL64;
	...
	/**
	 * @see com.pro.umbrella.common.util.MoneyUtils#of(BigDecimal)
	 */
	@Deprecated
	public static Money of(BigDecimal amount) {
		return MoneyUtils.of(amount);
	}
	...
	public static Money total(Money... monies) {
		return MoneyUtils.total(monies);
	}
